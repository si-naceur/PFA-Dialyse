...
/// Patient dossier screen. Mirrors the Django `Patient_Profile.html`: a
/// bordered header with the patient name, "Informations générales", "Contact",
/// "Antécédents médicaux" and "Historique des séances de dialyse" cards.
    ...
    return Scaffold(
      ...
      body: detailAsync.when(
        ...
        error: (error, _) => RefreshIndicator(
          onRefresh: () async {
            final result = ref.refresh(patientDetailProvider(patientId));
            if (result is Future) {
              await (result as Future).then<void>((_) {});
            }
          },
          child: ListView(
        ...
        data: (detail) => RefreshIndicator(
          ...
          child: ListView(
            ...
            children: [
              _DossierHeader(patientName: detail.patient.fullName),
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      _InfoTile(
                        background: const Color(0xFFFEF2F2), // red-50
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      _InfoTile(
                        background: const Color(0xFFECFDF5), // green-50
...
class _DossierHeader extends StatelessWidget {
  ...
  const _DossierHeader({required this.patientName});
